...
function getTotal(){
    ...
    com.executeAjax(dtServiceUrl.distributor_channel_achievement, data, "GET", function(result){
...
function getList(page) {
    ...
    var data = {
        ...
        sortBy:$('#sortBy').val(),
        relationship:$('#selRelationship').val()
    };
    if(my_interval=='custom'){
        data.start_date = my_start_date;
        data.end_date = my_end_date;
    }
    com.executeAjax(dtServiceUrl.distributor_my_dt_sales, data, "GET", function(result){
