        ...
        var order_two_vue = new Vue({
            ...
            methods:{
                submitOrder:function(event){
                    ...
                    var contentsbumit = '<div class="mask_content">' +
                                            '<i style="margin-top: -5px;margin-left: 30px" class="icon_warning fl"></i>' +
                                            '<p class="orange fs_24px">请确定您兑换的商品</p>' +
                                        '</div>';
                    var object2 = {
                        getid        : $("#orders_submit"),
                        text_title   : "提示",
                        text_content : contentsbumit,
                        text_input1  : "确认",
                        text_input2  : "取消"
                    };
                    com.mask(object2);
...
(function(){
    ...
    $("#more_other").click(function() {
        ...
        var h=($(".orders_card2").height())*($("#addrs_template").find(".orders_card2").length);
