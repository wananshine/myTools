            ...
            methods:{
                ...
                add_cart:function (obj) {
                    ...
                    com.executeAjax(cartUrl + orderServiceUrl.cart_add, data, "POST", function (result) {
                        var content = '<div class="f_c_666 center" style="height: 200px;line-height: 110px;padding-left: 90px;background:180px 40px url(../img/success_buy.png) no-repeat;background-size: 30px 30px">商品已成功加入进货单！</div>';
                        var object = {
                            getid        : $("#alert_mask"),
                            text_title   : "提示",
